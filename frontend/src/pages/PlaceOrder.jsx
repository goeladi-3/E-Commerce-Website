      ...
      switch (method) {
        ...
        case 'stripe':
          ...
          if (responseStripe.data.success) {}
            ...
            toast.info(responseStripe.data.message);
          }
          break;
    ...
    <form onSubmit={onSubmitHandler} className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t border-gray-300">
        ...
        <div className="flex flex-col gap-4 w-full sm:max-w-120">
          ...
          <div className="flex gap-3">
            ...
            <input required onChange={onChangeHandler} name='lasttName' value={formData.lastNameName} className="border border-gray-300 rounded py-1.5 px-3.5 w-full" placeholder="Last name" type="text" />
          </div>
