  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t border-gray-300">
        ...
        <div className="flex flex-col gap-4 w-full sm:max-w-120">
          ...
          <input required className="border border-gray-300 rounded py-1.5 px-3.5 w-full" placeholder="Email address" type="email" />
          ...
          <div className="flex gap-3">
            <input required className="border border-gray-300 rounded py-1.5 px-3.5 w-full" placeholder="Zipcode" type="number" />
        ...
        {/* Right Side: Total summary & Payment blocks */}
        <div className="mt-8">
